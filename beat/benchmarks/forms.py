...
class ToolUploadForm(forms.Form):
	...
	expression = forms.CharField(required=True, label="Regular Expression", help_text='The regular expression that should be used to parse output generated by this tool.')
